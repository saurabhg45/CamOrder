    ...
    $(document).ready(function() {
        ...
        $(window).on("scroll", function() {
            ...
            $(".drop_down_head").click(function() {
                ...
                $(".drop_down_body").slideToggle(300),
                    e.hasClass("bi-plus") ? e.attr("class", "bi-dash") : e.attr("class", "bi-plus")
            }),
        ...
        $(".account_close").click(function() {
            ...
            $(window).on("keydown", function(e) {
                "Escape" === e.key && (s.removeClass("overflow_hide"),
                    r.fadeOut(),
                    $(".account_swiper").slideUp())
            }),
        ...
        $(".hero_btn").click(function() {
            ...
            $(".bi-heart").click(function() {
                let e = $(this);
                e.hasClass("bi-heart") ? (e.attr("class", "bi-heart-fill"),
                    p("Added to wishlist")) : (e.attr("class", "bi-heart"),
                    p("Removed from wishlist"))
            }),
        ...
        $(".product_close").click(function() {
            ...
            $(window).on("click keydown", function(e) {
                ($(e.target).is(".product_modal .modal_centered") || "Escape" === e.key) && (s.removeClass("overflow_hide"),
                    a.removeClass("view"))
            })
    });